...
def get_multi_args_parser():
    ...
    parser.add_argument('-p', '--project-name', type=str, default='pytorch-cifar-examples', help='project name used for wandb logger')
...
if __name__ == '__main__':
    ...
    for setup in multi_args.setup:
        ...
        for model_name in multi_args.model_name:
            ...
            for option_name in ['cuda', 'output_dir', 'project_name', 'who', 'use_wandb']:
